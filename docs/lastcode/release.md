...
A candidate server starts in trial mode when the activation helper supplies
the exact trial environment:

```text
LASTCODE_ACTIVATION_MODE=trial
LASTCODE_ACTIVATION_REQUEST_ID=<drain request>
LASTCODE_ACTIVATION_TARGET_DIGEST=<64 lowercase hex>
```
