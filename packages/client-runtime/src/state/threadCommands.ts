...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    retryWorktreeCleanup: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:worktree-cleanup:retry",
    ...
    abandonWorktreeCleanup: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:worktree-cleanup:abandon",
    ...
    setPersistence: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:persistence:set",
    ...
    reopenAnnotation: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:annotation:reopen",
