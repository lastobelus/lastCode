...
import Migration0044 from "./Migrations/044_ProjectionThreadAnnotation.ts";
import Migration0045 from "./Migrations/045_UpdateDrain.ts";
import Migration0046 from "./Migrations/046_UpdateDrainClaim.ts";
import Migration0047 from "./Migrations/047_ProjectionTurnRequestCorrelations.ts";
import Migration0048 from "./Migrations/048_ProjectionThreadWorktreeCleanup.ts";
...
import Migration0051 from "./Migrations/051_ProjectionThreadMessageSource.ts";
import Migration0052 from "./Migrations/052_ProjectionThreadsPersistent.ts";
import Migration0053 from "./Migrations/053_ClearAutomaticProjectModelDefaults.ts";
import Migration0054 from "./Migrations/054_ProjectionProjectsAutoPull.ts";
import Migration0055 from "./Migrations/055_RepairAutomaticSettlementTimestamps.ts";
...
export const migrationEntries = [
  ...
  [44, "ProjectionThreadAnnotation", Migration0044],
  [45, "UpdateDrain", Migration0045],
  [46, "UpdateDrainClaim", Migration0046],
  [47, "ProjectionTurnRequestCorrelations", Migration0047],
  [48, "ProjectionThreadWorktreeCleanup", Migration0048],
  [49, "ProjectionThreadLinkedPullRequest", Migration0049],
  [50, "ProjectionThreadsUnsettledAt", Migration0050],
  [51, "ProjectionThreadMessageSource", Migration0051],
  [52, "ProjectionThreadsPersistent", Migration0052],
