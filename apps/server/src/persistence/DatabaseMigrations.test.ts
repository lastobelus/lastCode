...
for (const history of legacyMigrationHistories) {
  it.layer(NodeSqliteClient.layer({ filename: ":memory:" }))(history.source, (it) => {
    it.effect(
...
it.layer(NodeSqliteClient.layer({ filename: ":memory:" }))("fresh database", (it) => {
...
it.layer(NodeSqliteClient.layer({ filename: ":memory:" }))("mixed repaired history", (it) => {
  it.effect(
...
it.layer(NodeSqliteClient.layer({ filename: ":memory:" }))("unknown history", (it) => {
...
it.layer(NodeSqliteClient.layer({ filename: ":memory:" }))("conversion rollback", (it) => {
  it.effect(
...
it.layer(NodeSqliteClient.layer({ filename: ":memory:" }))("crossed released registries", (it) => {
...
it.layer(NodeSqliteClient.layer({ filename: ":memory:" }))("incompatible schema", (it) => {
...
it.layer(NodeSqliteClient.layer({ filename: ":memory:" }))("missing LastCode ledger", (it) => {
  it.effect(
