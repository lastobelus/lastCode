  ...
  Effect.gen(function* () {
    ...
    const events: ReadonlyArray<OrchestrationEvent> = [
      ...
      },
      {
        ...
        eventId: EventId.make("evt-wait-interrupt-requested"),
        aggregateKind: "thread",
        aggregateId: threadId,
        occurredAt,
        commandId: CommandId.make("cmd-wait-interrupt-requested"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-wait-interrupt-requested"),
        metadata: {},
