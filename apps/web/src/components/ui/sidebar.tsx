...
function SidebarMenuSubButton({
  ...
  const defaultProps = {
    className: cn(
      ...
      "data-[cleanup-pending=true]:cursor-not-allowed data-[cleanup-pending=true]:opacity-65",
      "data-[file-drag-over=true]:ring-1 data-[file-drag-over=true]:ring-inset data-[file-drag-over=true]:ring-primary/70",
      size === "sm" && "text-xs",
      size === "md" && "text-sm",
      "group-data-[collapsible=icon]:hidden",
      className,
